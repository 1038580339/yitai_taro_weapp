...
export default class ProjectDetail extends Component<any, any> {
    render() {
        return <View className="project_Detail">
            <View className="project_content">
                ...
                <Text className="project_content_text">项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：项目介绍：</Text>
                <Image className="project_content_img" src="../../assets/images/back.png"/>
                <Text className="project_title">参与报名：</Text>
                <Text className="project_title" style={{marginLeft: '30px'}}>线上：----------------</Text>
                <Text className="project_title" style={{marginLeft: '30px'}}>线下：---------------------</Text>
            </View>
            <View className="project_content project_content2">
                ...
                <View className="card">
                    ...
                    <View className="right_card">
                        <Text className="project_title3">公开课：用微信企业组好服务与增长</Text>
